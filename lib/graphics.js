        ...
        if (isGraphicsController) {
          ...
          if (parts.length > 1 && parts[0].replace(/ +/g, '').toLowerCase().indexOf('region') !== -1 && parts[1].toLowerCase().indexOf('memory') !== -1) {
            ...
            if (memparts.length > 1) {
              ...
              value = unit.toLowerCase() === 'k' ? value / 1024 :
                unit.toLowerCase() === 'g' ? value * 1024 :
                unit.toLowerCase() === 't' ? value * 1024 * 1024 :
                value;
              if (value > currentController.vram) currentController.vram = value;
            }
          }
        }
      }
